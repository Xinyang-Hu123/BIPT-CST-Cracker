...
image_query = cv2.imread('./test4/v2-e3f1a38161089207cd113ad7633d6bcb_1440w.jpg')
image_scene = cv2.imread('./test4/v2-aa71fbf01b8cf36f18cc5a24498a31b9_1440w.jpg') # 10/11为自拍的图像
...
img_obj = cv2.polylines(image_scene_copy, [np.int32(pts_corners_dst)], True, (0, 255, 255), 10)

# Draw matches:
img_matching = cv2.drawMatches(image_query, keypoints_1, image_scene, keypoints_2, best_matches, None,
                               matchColor=(255, 255, 0), singlePointColor=(255, 0, 255), flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
...
show_img_with_matplotlib(img_matching, "feature matching", 1)
